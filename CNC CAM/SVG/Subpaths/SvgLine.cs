...
{
    public class SvgLine : Subpath
    {
        public override Vector StartPoint { get; }
        private Vector _endPoint;
        private SvgLine continuation;
        public override Vector EndPoint => continuation?.EndPoint ?? _endPoint;

        public override double Length => ToGlobalPoint(_endPoint - StartPoint).Length + continuation?.Length ?? 0;
